...
ActiveRecord::Schema.define(version: 20150309063901) do
  ...
  create_table "configurations", force: :cascade do |t|
    ...
    t.integer  "password_length",           limit: 4, null: false
    t.integer  "password_history_count",    limit: 4, null: false
    t.integer  "entries_till_lock",         limit: 4, null: false
